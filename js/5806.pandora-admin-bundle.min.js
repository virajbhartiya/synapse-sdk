"use strict";(self.webpackChunkgh_pages_bundle=self.webpackChunkgh_pages_bundle||[]).push([[5806],{65806:(l,a,C)=>{C.r(a),C.d(a,{walletConnectBrownSvg:()=>e,walletConnectLightBrownSvg:()=>c,walletConnectSvg:()=>L});var t=C(12618);const L=t.JW`<svg fill="none" viewBox="0 0 96 67">
  <path
    fill="currentColor"
