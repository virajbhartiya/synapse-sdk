"use strict";(self.webpackChunkgh_pages_bundle=self.webpackChunkgh_pages_bundle||[]).push([[1978],{91978:(C,l,H)=>{H.r(l),H.d(l,{reownSvg:()=>F});const F=H(12618).JW`<svg width="60" height="16" viewBox="0 0 60 16" fill="none"">
